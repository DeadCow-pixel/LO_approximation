...
\label{eq:pxa}
   ...
   &\sim
    \exp\left[
    -\frac{(x-2\tilde q)^2}{2\sigma_x}-\frac{2\tilde q^2}{TV_{\ind{A}}+\xi}
    \right],
\end{align}
...
\begin{align}
    ...
    \end{pmatrix}
    \begin{pmatrix}
        \frac{TV_{\ind{A}}}4&\frac{TV_{\ind{A}}}{2}\\
        \frac{TV_{\ind{A}}}{2}&TV_{\ind{A}}+\sigma_x
    \end{pmatrix}^{-1}
    \begin{pmatrix}
        \tilde q\\x
    \end{pmatrix}\notag\\\equiv 
...
\begin{align}
\label{eq:IABPM}
    I_{\ind{AB}}^{\ind{HOM}}=\frac{1}{2}\log \frac{\Sigma^{\ind{H}}_{11}\Sigma^{\ind{H}}_{22}}
    {\det\Sigma^{\ind{H}}}=\frac{1}{2}\log \frac{TV_{\ind{A}}+\sigma_x+\xi}
    {\sigma_x+\xi},
\end{align}
...
\begin{align}
    &p_{\ind{A}}(\tilde \alpha) Q_x(\tilde \alpha)\notag\\
    &\sim
    \exp\left[-\frac{(x_1-\tilde q)^2}{\sigma_1}-\frac{\tilde q^2}{TV_{\ind{A}}+\xi}
    -\frac{(x_2-\tilde p)^2}{\sigma_2}-\frac{\tilde p^2}{TV_{\ind{A}}+\xi}
    \right],
\end{align}
and analogously to Eq.~\eqref{eq:sigma-hom-def}, we obtain covariance matrices as follows:
\begin{align}
  \label{eq:Sigma-DH}
    &\Sigma^{\ind{DH}^{(1)}}=\begin{pmatrix}
        \frac{TV_{\ind{A}}}2&\frac{TV_{\ind{A}}}{2}\\
        \frac{TV_{\ind{A}}}{2}&\frac{TV_{\ind{A}}}2+\frac{\sigma_1}{2}+\frac{\xi}{2}
    \end{pmatrix},\notag\\
    &\Sigma^{\ind{DH}^{(2)}}=\begin{pmatrix}
        \frac{TV_{\ind{A}}}2&\frac{TV_{\ind{A}}}{2}\\
        \frac{TV_{\ind{A}}}{2}&\frac{TV_{\ind{A}}}2+\frac{\sigma_2}{2}+\frac{\xi}{2}
    \end{pmatrix}
\end{align}
...
\begin{align}
    ...
    {\det\Sigma^{\ind{DH}^{(i)}}}\notag\\
    &=\frac{1}{2}\sum_i\log \frac{TV_{\ind{A}}+\sigma_i+\xi}
    {\sigma_i+\xi}.
\end{align}
