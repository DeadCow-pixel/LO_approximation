...
\begin{figure}
  ...
  \caption{Joint entropy as a function of squeezing parameter $r$ for different detector efficiencies. Unless specified, all beam spliiters are taken to be balanced. Parameters: $V_{\ind{A}}=1
